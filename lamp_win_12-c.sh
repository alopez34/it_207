...
winpty docker container run -d --name lamp  -p 80:80 --mount type=bind,source="/$current_directory",destination="//var/www/example.com/public_html" alopez34/it_207:latest
echo "=========================================================================="
